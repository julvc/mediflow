...
|---|---|---|
| `medi-java` | Spring Boot 3 / Java 17, Postgres, Flyway | API REST del dominio (Paciente, Profesional, Turno, Documento) |
...
- `medi-java`: dominio completo, API REST, migraciones, Dockerfile y tests unitarios/integración implementados.
- `medi-python`: pendiente.
- Frontend (React) e infraestructura como código (Terraform AWS/GCP): pendientes.
